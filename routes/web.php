...
Route::get('/catalogoadmin', [CatalogoController::class, 'indexadmin'])->name('catalogoadmin');; // Rota para a página de listagem de catálogos
...
Route::post('/catalogo/searchuser', [CatalogoController::class, 'searchuser'])->name('catalogo.searchuser');; //chama o formulario puxando o id


//Planos
Route::get('/planos', [PlanosController::class, 'index'])->name('planos');; // Rota para a página de listagem de catálogos
